...
export class TeapotBufferGeometry extends THREE.BufferGeometry {
	...
	constructor( size, segments, bottom, lid, body, fitLid, blinn ) {
		...
		let normOut = new THREE.Vector3();
		let v1, v2, v3, v4;

		let gmx = new THREE.Matrix4();
		let tmtx = new THREE.Matrix4();

		let vsp = new THREE.Vector4();
		let vtp = new THREE.Vector4();
		let vdsp = new THREE.Vector4();
		let vdtp = new THREE.Vector4();

		let vsdir = new THREE.Vector3();
		let vtdir = new THREE.Vector3();
		...
		let notDegenerate = function ( vtx1, vtx2, vtx3 ) {
